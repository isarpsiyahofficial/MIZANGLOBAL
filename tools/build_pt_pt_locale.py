...
OVERRIDES: dict[str, str] = {
    ...
    "Lefferion Prime - MİZAN hata yapabilir. Lütfen vade, gecikme ve ödeme bilgilerini son kez kontrol edin.": "O Lefferion Prime — MİZAN pode cometer erros. Verifique novamente os vencimentos, atrasos e dados de pagamento.",
}
