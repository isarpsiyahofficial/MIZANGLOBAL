...
7. Google Play purchases and restore. Lifetime Premium is a one-time Google Play in-app product. After the legal bundle has been accepted, the App can use Google Play's on-device billing APIs and purchase ownership/history information to load the product, begin a purchase, acknowledge a completed purchase and silently restore ownership. The App does not operate a publisher-owned purchase-verification server and does not send the raw purchase token to such a backend. Payment-card information is processed by Google Play, not by the App.
...
7. Rewarded temporary Premium. A free online user may be offered rewarded advertising. Three successfully completed eligible rewarded ads in the applicable reward day grant 24 hours of temporary Premium. An ad counts only after the advertising provider reports the reward callback. Closing, failing or abandoning an ad before that point does not increment progress. Reward availability is not guaranteed, has no cash value and cannot be transferred.
