...
class LanguageOption {
  ...
  bool matches(String query) {
    ...
    final haystack = normalizeGlobalSearch(
      '$code $nativeName $nameTr $nameEn $nameEs $namePtBr $namePtPt $nameFr $nameDe $nameIt $nameNl $namePl $nameRo $nameEl $nameRu $nameUk $nameAr $nameFa $nameHe $nameHi $nameBn $nameBn $nameBn',
    );
...
class CountryOption {
  ...
  bool matches(String query) {
    ...
    if (normalized.isEmpty) return true;
    final haystack = normalizeGlobalSearch(
      '$code $nameTr $nameEn $nameEs $namePtBr $namePtPt $nameFr $nameDe $nameIt $nameNl $namePl $nameRo $nameEl $nameRu $nameUk $nameAr $nameFa $nameHe $nameHi $nameBn $nameBn $nameBn $nativeName',
    );
    return haystack.split(' ').any((part) => part.startsWith(normalized)) ||
        haystack.contains(normalized);
  }
