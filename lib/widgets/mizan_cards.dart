...
class MizanListCard extends StatelessWidget {
  const MizanListCard({
    required this.title,
    required this.subtitle,
    this.leadingColor = MizanTheme.ink,
    this.trailing,
    this.onTap,
    this.icon,
    super.key,
...
class StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = switch (status) {
      PaymentStatus.active => MizanTheme.blue,
      PaymentStatus.upcoming => MizanTheme.orange,
      PaymentStatus.overdue => MizanTheme.red,
      PaymentStatus.completed => MizanTheme.green,
      PaymentStatus.passive => MizanTheme.muted,
    };
    return Container(
...
class SectionTitle extends StatelessWidget {
  const SectionTitle(this.title, {this.subtitle, this.action, super.key});
  final String title;
  final String? subtitle;
  final Widget? action;
          ...
          child: Column(
            ...
            children: [
              ...
              if (subtitle case final value?)
                Text(value, style: const TextStyle(color: MizanTheme.muted)),
            ],
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return Card(
      child: Padding(
        ...
        child: Column(
          children: [
            const Icon(Icons.inbox_outlined, color: MizanTheme.muted, size: 34),
            const SizedBox(height: 10),
            Text(
              title,
