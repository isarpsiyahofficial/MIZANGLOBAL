...
abstract final class MizanI18n {
  ...
  static String notificationText(String value){
    const defaults=<String>{'Sabah gider','Bugünkü giderlerini işlemeyi unutma.','Öğlen gider','Öğlene kadar yaptığın harcamaları ekleyebilirsin.','Akşam gider','Günü kapatmadan giderlerini kontrol et.','Ödeme hatırlatması 1','Ödeme hatırlatması 2','Ödeme hatırlatması 3','Yaklaşan ve gecikmiş ödemelerini kontrol et.','Günün ödeme planını gözden geçir.'};
  ...
  static String text(String source,{String? languageTag}){
    ...
    final visibleSource=source.replaceAllMapped(RegExp('\u{E000}([A-Za-z0-9_\\-=]+)\u{E001}'),(match){
      ...
      try{protected[token]=utf8.decode(base64Url.decode(match[1]!));}on Object{protected[token]='';}
      return token;
    });
    String result;
