const Map<String, String> mizanPortugueseBr = <String, String>{
  ...
  'MİZAN yaklaşık zamanlama kullanmaz. Kaydettiğinde gerekli Android izin ekranı otomatik açılır; izin verildiğinde bildirimler uygulamaya dönüşte otomatik senkronize edilir.':
      'O MİZAN não usa horários aproximados. Ao salvar, a tela de permissão necessária do Android será aberta automaticamente; depois que a permissão for concedida, as notificações serão sincronizadas automaticamente ao retornar ao aplicativo.',
  '1 dakika sonra test bildirimi': 'Notificação de teste em 1 minuto',
  'Bu hatırlatmayı sil': 'Excluir este lembrete',
  ...
  'Diğer hatırlatmalar ve kayıtlar etkilenmez.':
      'Os outros lembretes e registros não serão afetados.',
  'MİZAN CSV yedeğini kaydet': 'Salvar backup CSV do MİZAN',
  'CSV yedeği oluşturuldu.': 'O backup CSV foi criado.',
  'CSV yedeği oluşturulamadı': 'Não foi possível criar o backup CSV',
  'MİZAN CSV yedeğini seç': 'Selecionar backup CSV do MİZAN',
  'Seçilen CSV dosyası okunamadı.':
      'Não foi possível ler o arquivo CSV selecionado.',
  'CSV yedeği birleştirilemedi': 'Não foi possível mesclar o backup CSV',
  'CSV yedeğini birleştir': 'Mesclar backup CSV',
  'Mevcut kayıtlar silinmeyecek veya yedekteki ortak verilerle yeniden yazılmayacak. Yalnız yeni kayıtlar ve eksik alt ilişkiler eklenecek.':
      'Os registros existentes não serão excluídos nem substituídos por dados correspondentes do backup. Somente novos registros e vínculos secundários ausentes serão adicionados.',
  'Yeni eklenecek': 'Novos registros a adicionar',
  'Eksik ilişkisi tamamlanacak': 'Vínculos ausentes a completar',
  'Ortak kullanıcı kaydı: Yok': 'Registros correspondentes do usuário: nenhum',
  'Ortak kullanıcı kaydı atlanacak':
      'Registros correspondentes do usuário a ignorar',
  ...
  'Öğlene kadar yaptığın harcamaları ekleyebilirsin.':
      'Você pode adicionar as despesas feitas até o meio-dia.',
  'Akşam gider': 'Despesas da noite',
  'Günü kapatmadan giderlerini kontrol et.':
      'Confira suas despesas antes de encerrar o dia.',
  'Günün ödeme planını gözden geçir.': 'Confira o plano de pagamentos de hoje.',
  'Kategori silmek için tam olarak ONAYLIYORUM yazılmalı.':
      'Para excluir a categoria, digite exatamente CONFIRMO.',
  'CSV yedeği doğrulandı ve geri yüklendi.':
      'O backup CSV foi verificado e restaurado.',
  'CSV yedeği mevcut kayıtlarla birleştirildi: ':
      'O backup CSV foi mesclado com os registros existentes: ',
  'Banka': 'Banco',
  'Borç': 'Dívida',
  'Kişisel/kurumsal borç': 'Dívida pessoal/empresarial',
  'Kira': 'Aluguel',
  'Gider': 'Despesa',
  'Eski kayıttan aktarıldı': 'Importado de um registro antigo',
  ...
  'CSV yedeği boş veya eksik.': 'O backup CSV está vazio ou incompleto.',
  'Bu dosya MİZAN CSV yedeği değil.':
      'Este arquivo não é um backup CSV do MİZAN.',
  'CSV tam yedek verisi geçersiz.':
      'Os dados do backup CSV completo são inválidos.',
  ...
  'Daha fazla gider günü göster ': 'Mostrar mais dias de despesas ',
  'Kişi kaydı bulunmuyor.': 'Nenhum registro de pessoa foi encontrado.',
  'MİZAN full backup': 'Backup completo do MİZAN',
  'MİZAN tam yedek': 'Backup completo do MİZAN',
  ...
  'Kişi kapsamı: Kayıtlı kişi yok':
      'Escopo de pessoas: nenhuma pessoa registrada',
  ...
  'FileSystemException: ': 'Erro do sistema de arquivos: ',
