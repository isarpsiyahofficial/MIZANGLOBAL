...
const Map<String, String> mizanPortugueseBr = <String, String>{
  ...
  'Aşağıdaki bütün kayıtlar yalnızca seçili kişiye aittir.':
      'Todos os registros abaixo pertencem somente à pessoa selecionada.',
  'Kişi seçin': 'Selecionar pessoa',
  'Kalan toplam': 'Total restante',
  'Bu ay planlanan': 'Programado para este mês',
  'Gecikmiş kayıt': 'Registro em atraso',
  'Kişi detaylarını aç': 'Abrir detalhes da pessoa',
  'Arşivdekileri göster': 'Mostrar registros arquivados',
  'Kişi kaydı bulunamadı.': 'O registro da pessoa não foi encontrado.',
  'Gecikmiş kayıtlar': 'Registros em atraso',
  'Bu başlıkta kayıt bulunmuyor.':
      'Nenhum registro foi encontrado nesta seção.',
  'Kişi detayları': 'Detalhes da pessoa',
  'Bu kişiye ait kayıtlar': 'Registros desta pessoa',
  'Bu kişiye bağlı açık ödeme kaydı yok.':
      'Não há pagamentos em aberto vinculados a esta pessoa.',
  'Kişiyi düzenle': 'Editar pessoa',
  'Kişiyi sil': 'Excluir pessoa',
  ...
  'Banka adı kullanıcı tarafından yazılır. Hazır banka markası veya logosu kullanılmaz.':
      'O nome do banco é informado pelo usuário. Nenhuma marca ou logotipo bancário predefinido é utilizado.',
  'Banka grubu işlemleri': 'Operações do grupo bancário',
  'Banka grubunu sil': 'Excluir grupo bancário',
  ...
  'Kayıt bilgileri': 'Informações do registro',
  'Ödeme geçmişi': 'Histórico de pagamentos',
  'Yalnızca bu kayda bağlı ödemeler':
      'Somente pagamentos vinculados a este registro',
  'Ödeme yok': 'Nenhum pagamento',
  'Bu kayda henüz ödeme eklenmedi.':
      'Ainda não foi adicionado nenhum pagamento a este registro.',
  'Ödemeyi sil': 'Excluir pagamento',
  ...
  'Çek no': 'Nº do cheque',
  'Senet no': 'Nº da nota promissória',
  'Kalan fatura': 'Valor restante da conta',
  'Fatura düzeni': 'Programação da conta',
  'Ödeme günü': 'Dia do pagamento',
  'İlk fatura ayı': 'Primeiro mês da conta',
  'Kayıtlı değişken tutarlar': 'Valores variáveis registrados',
  'Abone no': 'Nº do assinante',
  'Sözleşme / tesisat no': 'Nº do contrato / instalação',
  'Bu dönem kalan': 'Restante neste período',
  'Tekrar sıklığı': 'Frequência de repetição',
  'Sözleşme no': 'Nº do contrato',
  ...
  'Kalan taksit sayısı toplam taksit sayısını aşamaz.':
      'O número de parcelas restantes não pode ultrapassar o total de parcelas.',
  'Kalan taksit sayısı, kayıtlı taksit ödemeleriyle uyumlu değil.':
      'O número de parcelas restantes não corresponde aos pagamentos de parcelas registrados.',
  'Hazır marka listesi yoktur; adı kullanıcı belirler.':
      'Não há uma lista de marcas predefinida; o usuário informa o nome.',
  ...
  '1 ile 31 arasında bir gün girin.': 'Informe um dia entre 1 e 31.',
  ...
  'Takvimle otomatik artar. Diğer alanları kaydetmek bu gecikme referansını değiştirmez.':
      'O valor aumenta automaticamente conforme o calendário. Salvar os outros campos não altera esta referência de atraso.',
  ...
  'Ödeme kaydı eklendikçe otomatik azalır.':
      'Diminui automaticamente conforme os pagamentos são registrados.',
  ...
  'Elektrik, su, doğalgaz ve benzeri faturaların tutarı her ay ayrı kaydedilir. Geçmiş ayların tutarı değiştirilmeden raporlarda gerçek ödeme kayıtları kullanılır.':
      'Os valores de energia elétrica, água, gás natural e contas semelhantes são registrados separadamente a cada mês. Os relatórios usam os pagamentos reais sem alterar os valores dos meses anteriores.',
  'Tesisat / sözleşme numarası': 'Número da instalação / contrato',
  'Kira / taksiti düzenle': 'Editar aluguel / Parcela',
  'Kira başlığı': 'Título do aluguel',
  'Ürün / taksit başlığı': 'Título do produto / Parcela',
  'Aylık kira tutarı': 'Valor mensal do aluguel',
  ...
  'Kapalıysa kayıt tek ödeme olarak değerlendirilir.':
      'Quando desativado, o registro é tratado como um pagamento único.',
  '15 veya 20 gibi yalnız gün numarasını yazın; MİZAN takvimi kendisi takip eder.':
      'Informe somente o número do dia, como 15 ou 20; o MİZAN acompanhará o calendário automaticamente.',
  ...
  'Kira artış tarihi (opsiyonel)': 'Data de reajuste do aluguel (opcional)',
  'Toplam taksit (opsiyonel)': 'Total de parcelas (opcional)',
  'Toplam taksit sayısını girin.': 'Informe o número total de parcelas.',
  ...
  'Taksitli ödeme planı': 'Plano de pagamento parcelado',
  'Açıksa taksit sayısı ve düzenli ödeme tutarı saklanır.':
      'Quando ativado, o número de parcelas e o valor do pagamento recorrente são armazenados.',
  'Özel ödeme aralığı (gün)': 'Intervalo de pagamento personalizado (dias)',
  'Gün sayısını girin.': 'Informe o número de dias.',
  'Toplam taksiti girin.': 'Informe o total de parcelas.',
  'Ödeme kaydı eklendikçe kalan taksit sayısı otomatik azalır.':
      'O número de parcelas restantes diminui automaticamente conforme os pagamentos são registrados.',
  'Çeki düzenleyen kişi / kurum': 'Pessoa / Instituição emitente do cheque',
  'Banka bilgisi (kullanıcı girişi)':
      'Informações bancárias (preenchidas pelo usuário)',
  'Senet adedi': 'Quantidade de notas promissórias',
  'Mevcut senet': 'Nota promissória atual',
  'Birden fazla senet varsa her biri ayrı vade satırı olarak oluşturulur.':
      'Se houver mais de uma nota promissória, cada uma será criada como uma linha de vencimento separada.',
  'Aboneliği düzenle': 'Editar assinatura',
  ...
  'Bu kaydın planlanan taksit/dönem tutarı otomatik kullanılır.':
      'O valor programado da parcela ou do período deste registro é usado automaticamente.',
  ...
  'Kalan borcu aşmayacak ödeme tutarını kendin girebilirsin.':
      'Você pode informar um valor de pagamento que não ultrapasse o saldo restante.',
