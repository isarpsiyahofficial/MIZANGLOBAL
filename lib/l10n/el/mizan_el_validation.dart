const Map<String, String> mizanGreekValidation = <String, String>{
  ...
  'Gecikme günü': 'Ημέρες καθυστέρησης',
  'Limit': 'Οριο',
  'Kullanılan limit': 'Χρησιμοποιημένο όριο',
  'Açıklama': 'Περιγραφή',
  'Düzenli ödeme tutarı': 'Τακτικό ποσό πληρωμής',
  'Borç başlığı': 'Τίτλος χρέους',
  'Alacaklı adı': 'Όνομα πιστωτή',
  'Çek numarası': 'Αριθμός επιταγής',
  'Düzenleyen': 'Εκδότης',
  'Banka bilgisi': 'Τραπεζικές πληροφορίες',
  'Senet numarası': 'Αριθμός γραμματίου',
  ...
  'Kira/taksit başlığı': 'Τίτλος ενοικίου/δόσης',
  'Alıcı adı': 'Όνομα παραλήπτη',
  'IBAN': 'IBAN',
  'Adet': 'Ποσότητα',
  'Birim fiyat': 'Τιμή μονάδας',
  'Gider adı': 'Όνομα εξόδου',
  'Gider notu': 'Σημείωση εξόδου',
  'Ödeme tutarı': 'Ποσό πληρωμής',
  'Ödeme notu': 'Σημείωση πληρωμής',
