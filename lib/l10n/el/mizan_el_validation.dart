...
const Map<String, String> mizanGreekValidation = <String, String>{
  ...
  'Global katalog sayıları doğrulanamadı.': 'Δεν ήταν δυνατή η επαλήθευση των παγκόσμιων καταλόγων.',
  ...
  'Yerel kayıt alanı güvenli biçimde açılamadı. Mevcut dosyaları korumak için yeni veri yazımı durduruldu.': 'Ο τοπικός χώρος αποθήκευσης δεν ήταν δυνατό να ανοίξει με ασφάλεια. Οι νέες εγγραφές έχουν διακοπεί για την προστασία των υπαρχόντων αρχείων.',
