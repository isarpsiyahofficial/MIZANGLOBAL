...
const Map<String, String> mizanBengaliReports = <String, String>{
  ...
  'Gelir ayrıntıları': 'আয়ের বিবরণ',
  'Serbest girilen gelir türleri ve seçili döneme düşen tutarları gösterilir.':
      'ব্যবহারকারীর প্রবেশ করা আয়ের ধরন এবং নির্বাচিত সময়ের মধ্যে পড়ে থাকা পরিমাণ দেখায়।',
  'Seçili dönemde gelir oluşmuyor.': 'কোনো আয় নির্বাচিত সময়ের মধ্যে পড়ে না।',
  ...
  'Günlük harcamalar ve ödeme geçmişi ayrı kaynaklar olarak, en yüksek tutardan en düşüğe sıralanır.':
      'দৈনিক খরচ এবং পরিশোধের ইতিহাসকে পৃথক উৎস হিসাবে বিবেচনা করা হয় এবং সর্বোচ্চ থেকে সর্বনিম্ন পরিমাণে সাজানো হয়।',
  ...
  'Seçili kapsamda gerçekleşen ödeme bulunmuyor.':
      'নির্বাচিত সুযোগের মধ্যে কোনো নথিভুক্ত পরিশোধ পাওয়া যায়নি।',
  'Kalan ödeme yükünün dağılımı': 'অবশিষ্ট পরিশোধের দায়ের বণ্টন',
  ...
  'Her gün başlık olarak gösterilir. Başlığa dokununca günlük harcamalar ve ödemeler kendi bölümlerinde açılır.':
      'প্রতিটি দিন একটি শিরোনাম হিসাবে দেখানো হয়. তাদের নিজস্ব বিভাগে দৈনিক খরচ এবং পরিশোধ প্রসারিত করতে এটি আলতো চাপুন।',
  'Seçili dönemde gider veya ödeme ayrıntısı bulunmuyor.':
      'নির্বাচিত সময়ের মধ্যে কোনো খরচ বা পরিশোধের বিবরণ পাওয়া যায়নি।',
  'Kişi kapsamı': 'মানুষ অন্তর্ভুক্ত',
  'Tüm kişileri kapsa': 'সব মানুষ অন্তর্ভুক্ত',
  'Bütün kişilerin ödeme ve borç kayıtları rapora alınır.':
      'সমস্ত লোকের জন্য পরিশোধ এবং ঋণের রেকর্ড প্রতিবেদনে অন্তর্ভুক্ত করা হয়েছে।',
  ...
  'Normal gider ayrıntıları': 'নিয়মিত খরচের বিবরণ',
  'Ödeme ayrıntıları': 'পরিশোধ বিশদ',
  'Kalan ödeme yükü ayrıntıları': 'অবশিষ্ট পরিশোধের দায়ের বিস্তারিত',
  ...
  'Normal giderler ve ödemeler ayrı başlıklar altında kalır; yalnız toplam hesaplamada birleşir.':
      'নিয়মিত খরচ এবং পরিশোধ পৃথক শিরোনামের অধীনে থাকে এবং শুধুমাত্র মোট গণনা করার সময় একত্রিত হয়।',
  'Seçili döneme taşınan gecikmiş kayıtlar ile dönemin açık ödeme yükü ayrıntılı gösterilir.':
      'মেয়াদের বকেয়া পরিশোধ বাধ্যবাধকতা সহ নির্বাচিত সময়ের মধ্যে বাহিত মেয়াদোত্তীর্ণ রেকর্ড দেখায়।',
  ...
  'Raporun referans gününden itibaren önümüzdeki 7 gün içinde vadesi kalan açık kayıtlar gösterilir.':
      'প্রতিবেদনের রেফারেন্স তারিখের সাত দিনের মধ্যে খোলা রেকর্ড দেখায়।',
  ...
  'Güncel ay her zaman açılır; geçmişte kayıt, ödeme, gider veya gelir bulunan aylar ayrıca seçilebilir.':
      'বর্তমান মাস সর্বদা উপলব্ধ; রেকর্ড, পরিশোধ, খরচ, বা আয়ের সাথে আগের মাসগুলিও নির্বাচন করা যেতে পারে।',
  'Güncel yıl her zaman açılır; kayıt bulunan geçmiş yıllar ayrıca seçilebilir.':
      'বর্তমান বছর সবসময় পাওয়া যায়; রেকর্ড ধারণকারী বিগত বছর এছাড়াও নির্বাচন করা যেতে পারে.',
  'İlk kayıttan bugüne kadar bütün ödeme, gider ve gelir hareketleri kapsanır.':
      'প্রথম রেকর্ড থেকে আজ পর্যন্ত সমস্ত পরিশোধ, খরচ এবং আয়ের কার্যকলাপ অন্তর্ভুক্ত।',
  'Kalan kayıt durumu (opsiyonel)': 'অসামান্য রেকর্ড স্থিতি (ঐচ্ছিক)',
  'Tüm durumlar': 'সব স্ট্যাটাস',
  'Gider kayıtlarında kişi alanı bulunmadığı için giderler seçili dönem kapsamında ve kişi filtresinden bağımsız hesaplanır.':
      'যেহেতু খরচের রেকর্ডে কোনো ব্যক্তি ক্ষেত্র নেই, তাই নির্বাচিত সময়ের জন্য খরচ গণনা করা হয় ব্যক্তি ফিল্টার থেকে স্বাধীনভাবে।',
  'Kayıtlı yılı seç': 'একটি সংরক্ষিত বছর নির্বাচন করুন',
  'Kayıtlı ayı seç': 'একটি সংরক্ষিত মাস নির্বাচন করুন',
  'Gelir ve net durum': 'আয় এবং নেট অবস্থান',
  'Gelirden gerçekleşen ödemeler ve giderler sırayla düşülür.':
      'রেকর্ডকৃত পরিশোধ এবং খরচ ক্রমানুসারে আয় থেকে বাদ দেওয়া হয়।',
  'PDF raporu': 'PDF প্রতিবেদন',
  ...
  'PDF hazırlanıyor': 'PDF প্রস্তুত করা হচ্ছে',
  'PDF indir': 'PDF ডাউনলোড করুন',
  'PDF paylaş': 'PDF শেয়ার করুন',
  'Seçili dönem gider özeti': 'নির্বাচিত সময়ের খরচের সারাংশ',
  'Bütün harcamalar, normal giderler ile banka, şahıs, fatura, abonelik, kira ve taksit ödemelerinin toplamıdır.':
      'সমস্ত খরচ হল নিয়মিত খরচ এবং ব্যাঙ্ক ঋণ, ব্যক্তিগত ঋণ, বিল, সাবস্ক্রিপশন, ভাড়া, এবং কিস্তি পরিশোধের সম্মিলিত মোট।',
  'Normal giderler ile banka, şahıs, fatura, abonelik, kira ve taksit ödemelerine yapılan giderlerin toplamıdır. Gelir ayrı gösterilir.':
      'ব্যাঙ্ক ঋণ, ব্যক্তিগত ঋণ, বিল, সাবস্ক্রিপশন, ভাড়া এবং কিস্তির প্রতি নিয়মিত খরচ এবং পরিশোধের সম্মিলিত মোট। আয় আলাদাভাবে দেখানো হয়।',
  ...
  'Kişi bazında güncel kalan borç': 'ব্যক্তি দ্বারা বর্তমান বকেয়া ঋণ',
  'Kişi ve kayıt türü başlıklarına dokunarak ayrıntıları açıp kapatabilirsiniz. Kayıt satırına dokununca tam kayıt detayı açılır.':
      'বিশদ বিবরণ প্রসারিত বা সঙ্কুচিত করতে ব্যক্তি এবং রেকর্ড-টাইপ শিরোনামে আলতো চাপুন। একটি রেকর্ড সারি এর সম্পূর্ণ বিবরণ খুলতে আলতো চাপুন।',
  'Toplam kalan': 'মোট মেয়াদোত্তীর্ণ',
  'Hafta': 'সপ্তাহ',
  'Tüm zamanlar': 'সব সময়',
  'PDF rapor sayfası görüntüye dönüştürülemedi.':
      'PDF প্রতিবেদনের পৃষ্ঠা ছবিতে রূপান্তর করা যায়নি।',
  'Sayfa': 'পাতা',
  'finans raporu': 'আর্থিক প্রতিবেদন',
  'Kayıtlı kişi yok': 'কোন সংরক্ষিত মানুষ',
  'GÜN BAŞLIĞI': 'দিনের শিরোনাম',
  'Rapor özeti': 'প্রতিবেদনের সারাংশ',
  'Ödeme kayıtları ve Giderler bölümü birbirine karıştırılmadan hesaplanır.':
      'পরিশোধের রেকর্ড এবং খরচ বিভাগ তাদের উত্স মিশ্রিত না করে গণনা করা হয়।',
  'Ödemeler sonrası kalan gelir': 'পরিশোধ পরে আয় বাকি',
  'Toplam gider sonrası net': 'মোট খরচের পর নিট অবস্থা',
  'Seçili dönemde kalan ödeme yükü':
      'নির্বাচিত সময়ের মধ্যে বকেয়া পরিশোধ বাধ্যবাধকতা',
  ...
  'Gelir türleri seçili döneme düşen tekrar sayısına göre hesaplanır.':
      'আয়ের প্রকারগুলি নির্বাচিত সময়ের মধ্যে সংঘটিত হওয়ার সংখ্যা দ্বারা গণনা করা হয়।',
  'Seçili dönem ve kişi kapsamındaki ödeme geçmişi kayıt türüne göre ayrılır.':
      'নির্বাচিত সময়ের মধ্যে পরিশোধের ইতিহাস এবং লোকেদের সুযোগ রেকর্ডের প্রকার দ্বারা পৃথক করা হয়।',
  'Her ödeme yalnız bağlı olduğu kişi ve kayıt altında gösterilir.':
      'প্রতিটি পরিশোধ শুধুমাত্র তার সংযুক্ত ব্যক্তি এবং রেকর্ডের অধীনে দেখানো হয়।',
  'Gecikmiş kayıtlarda gösterilen taksit ve ana para tutarlarına işleyebilecek faizler, gecikme bedelleri ve diğer olası durum etkenleri dahil değildir.':
      'মেয়াদোত্তীর্ণ রেকর্ডের জন্য দেখানো কিস্তি এবং মূল পরিমাণে সম্ভাব্য সুদ, বিলম্বের ফি, বা প্রযোজ্য হতে পারে এমন অন্যান্য কারণ অন্তর্ভুক্ত নয়।',
  ...
  'Normal giderler ve ödeme kayıtları aynı rapor toplamına dahil edilir; kaynakları birbirine karıştırılmadan ayrı renklerle gösterilir.':
      'নিয়মিত খরচ এবং পরিশোধের রেকর্ডগুলি একই প্রতিবেদনে মোট অন্তর্ভুক্ত করা হয়েছে এবং তাদের উত্সগুলিকে মিশ্রিত না করে আলাদা রঙে দেখানো হয়েছে।',
  ...
  'Günler başlık olarak gösterilir; her günün normal harcamaları ve ödemeleri kendi bölümünde, satır taşması olmadan listelenir.':
      'দিনগুলি শিরোনাম হিসাবে দেখানো হয়; প্রতিটি দিনের নিয়মিত খরচ এবং পরিশোধ পাঠ্য ওভারফ্লো ছাড়াই তাদের নিজস্ব বিভাগে তালিকাভুক্ত করা হয়।',
  'Seçili dönemde gider ayrıntısı bulunmuyor.':
      'নির্বাচিত সময়ের মধ্যে কোনো খরচের বিবরণ পাওয়া যায়নি।',
  'Toplam borcun tamamı değil, seçili döneme düşen sıradaki ödeme/taksit tutarları gösterilir.':
      'নির্বাচিত সময়ের মধ্যে পরবর্তী পরিশোধ/কিস্তির পরিমাণ দেখায়, সম্পূর্ণ ঋণ ব্যালেন্স নয়।',
  'Vade, kişi, kayıt türü, gecikme süresi ve sıradaki ödeme tutarı birlikte sunulur.':
      'শেষ তারিখ, ব্যক্তি, রেকর্ডের ধরন, মেয়াদোত্তীর্ণ সময়কাল এবং পরবর্তী পরিশোধের পরিমাণ একসাথে দেখানো হয়েছে।',
