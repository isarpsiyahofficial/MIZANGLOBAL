...
String _updatedLinks(String value) =>
    '${_number(value)} mahusiano yamesasishwa';
...
final List<_SwahiliPattern> _swahiliPatterns = <_SwahiliPattern>[
  _SwahiliPattern(
    ...
    (m, t) => 'Ripoti ya ${t(m[1]!)} ya MİZAN',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) finans raporu$'),
    (m, t) => 'Ripoti ya fedha ya ${m[1]}',
  ),
  _SwahiliPattern(
    RegExp(r'^LEFFERION PRIME - MİZAN · Sayfa (\d+)$'),
    (m, t) => 'LEFFERION PRIME - MİZAN · Ukurasa ${_number(m[1]!)}',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) · devam$'),
    (m, t) => '${t(m[1]!)} · inaendelea',
  ),
  _SwahiliPattern(RegExp(r'^Dönem: (.+)$'), (m, t) => 'Kipindi: ${m[1]}'),
  _SwahiliPattern(
    RegExp(r'^Kişi kapsamı: (.+)$'),
    (m, t) => 'Wigo wa watu: ${t(m[1]!)}',
  ),
  _SwahiliPattern(
  ...
  _SwahiliPattern(
    ...
    (m, t) => 'Mpango wazi ${m[1]} · Yaliyofanyika mwezi huu ${m[2]}',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) Ödeme Durumu$'),
    (m, t) => 'Hali ya Malipo ya ${m[1]}',
  ),
  _SwahiliPattern(
  ...
  _SwahiliPattern(
    ...
    (m, t) => 'Onyesha siku zaidi (${_remaining(m[1]!)})',
  ),
  _SwahiliPattern(
    RegExp(r'^Daha fazla ödeme günü göster \((\d+) kaldı\)$'),
    (m, t) => 'Onyesha siku zaidi za malipo (${_remaining(m[1]!)})',
  ),
  _SwahiliPattern(
    RegExp(r'^Daha fazla gider günü göster \((\d+) kaldı\)$'),
    (m, t) => 'Onyesha siku zaidi za matumizi (${_remaining(m[1]!)})',
  ),
  _SwahiliPattern(
    RegExp(r'^Bu günden daha fazla göster \((\d+) kaldı\)$'),
    (m, t) => 'Onyesha rekodi zaidi za siku hii (${_remaining(m[1]!)})',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) için (\d+) gün kaldı$'),
    (m, t) => '${_remainingDays(m[2]!)} hadi ${m[1]}',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) bugün bekleniyor$'),
    (m, t) => '${m[1]} yanatarajiwa leo',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) (\d+) gün gecikti$'),
    (m, t) => '${m[1]} imechelewa ${_days(m[2]!)}',
  ),
  _SwahiliPattern(
    RegExp(r'^Son alındı: (.+) · Planlanan (.+)$'),
    (m, t) => 'Ilipokelewa mwisho: ${m[1]} · Iliyopangwa: ${m[2]}',
  ),
  _SwahiliPattern(
    RegExp(
    ...
    (m, t) =>
        'Kipindi kilichopangwa cha ${m[1]} kimerekodiwa kuwa kimepokelewa tarehe ${m[2]}. Siku ya kawaida ya kupokea haijabadilika.',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) gerçek fatura tutarı$'),
    (m, t) => 'Kiasi halisi cha bili ya ${m[1]}',
  ),
  _SwahiliPattern(
    RegExp(r'^Kalan tutar: (.+)$'),
    (m, t) => 'Kiasi kilichobaki: ${m[1]}',
  ),
  _SwahiliPattern(
  ...
  _SwahiliPattern(
    ...
    (m, t) => 'Futa rekodi ya matumizi ${m[1]}?',
  ),
  _SwahiliPattern(
    RegExp(
    ...
    (m, t) =>
        'Kategoria ${m[1]} na matumizi yaliyounganishwa na kategoria hii pekee yatafutwa.',
  ),
  _SwahiliPattern(
    RegExp(
    ...
    (m, t) =>
        '${m[1]} na rekodi zote zinazohusishwa na mtu huyu zitafutwa. Kitendo hiki kinahitaji uthibitisho wa wazi.',
  ),
  _SwahiliPattern(
    RegExp(r'^PDF raporu kaydedilemedi: (.+)$'),
    (m, t) => 'Ripoti ya PDF haikuweza kuhifadhiwa: ${m[1]}',
  ),
  _SwahiliPattern(
    RegExp(r'^PDF raporu paylaşılamadı: (.+)$'),
    (m, t) => 'Ripoti ya PDF haikuweza kushirikiwa: ${m[1]}',
  ),
  _SwahiliPattern(
    RegExp(
  ...
  _SwahiliPattern(
    ...
    (m, t) => 'Kikumbusho cha malipo ${_number(m[1]!)}',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) yeni, (.+) ilişki güncellendi(.*)\.$'),
    (m, t) =>
        '${_newItems(m[1]!)} zimeongezwa na ${_updatedLinks(m[2]!)}${m[3]}.',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) kayıt kimliği geçersiz veya tekrarlı\.$'),
    (m, t) => 'Kitambulisho cha rekodi ${m[1]} si halali au kimerudiwa.',
  ),
  _SwahiliPattern(
  ...
  _SwahiliPattern(
    ...
    (m, t) => 'Imechelewa ${_days(m[1]!)}',
  ),
  _SwahiliPattern(
    RegExp(r'^Ödeme (\d+) gün gecikti\.$'),
    (m, t) => 'Malipo yamechelewa ${_days(m[1]!)}.',
  ),
  _SwahiliPattern(
    RegExp(r'^Son ödeme (.+)\.$'),
    (m, t) => 'Tarehe ya mwisho ${m[1]}.',
  ),
  _SwahiliPattern(
    RegExp(r'^Ayın (\d+)\. günü$'),
    (m, t) => 'Tarehe ${_number(m[1]!)} ya mwezi',
  ),
  _SwahiliPattern(
    RegExp(r'^Her ayın (\d+)\. günü$'),
    (m, t) => 'Tarehe ${_number(m[1]!)} ya kila mwezi',
  ),
  ...
  _SwahiliPattern(
    ...
    (m, t) => '${t(m[1]!)} haiwezi kuwa hasi.',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) pozitif tam sayı olmalı\.$'),
    (m, t) => '${t(m[1]!)} lazima iwe namba kamili chanya.',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) sıfır veya pozitif tam sayı olmalı\.$'),
    (m, t) => '${t(m[1]!)} lazima iwe sifuri au namba kamili chanya.',
  ),
  ...
  _SwahiliPattern(
    ...
    (m, t) => '${_newItems(m[1]!)} zimeongezwa; data iliyopo imehifadhiwa.',
  ),
  _SwahiliPattern(
    RegExp(r'^Test (.+) için dakik olarak planlandı\.$'),
    (m, t) => 'Jaribio la ${m[1]} limepangwa kwa muda sahihi.',
  ),
  _SwahiliPattern(
    RegExp(r'^Test planlanamadı: (.+)$'),
    (m, t) => 'Jaribio halikuweza kupangwa: ${m[1]}',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) planlanamadı: (.+)$'),
    (m, t) => '${t(m[1]!)} haikuweza kupangwa: ${m[2]}',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) kaydedilemedi: (.+)$'),
    (m, t) => '${t(m[1]!)} haikuweza kuhifadhiwa: ${m[2]}',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) oluşturulamadı: (.+)$'),
    (m, t) => '${t(m[1]!)} haikuweza kuundwa: ${m[2]}',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) paylaşılamadı: (.+)$'),
    (m, t) => '${t(m[1]!)} haikuweza kushirikiwa: ${m[2]}',
  ),
  _SwahiliPattern(
    RegExp(r'^(.+) birleştirilemedi: (.+)$'),
    (m, t) => '${t(m[1]!)} haikuweza kuunganishwa: ${m[2]}',
  ),
];
