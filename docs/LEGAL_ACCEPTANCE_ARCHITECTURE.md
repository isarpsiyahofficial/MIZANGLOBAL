...
- Promotion validation is embedded locally using cryptographic fingerprints. ESMANUR grants 7 days and LEFFERION grants 3 days, while the validator does not store either code as ordinary plaintext.
