...
Future<void> _visitRussianTabs(WidgetTester tester) async {
...
void main() {
  testWidgets('Russian 320x568 at 1.4x renders all tabs without overflow', (
    tester,
  ) async {
    await _pumpRussianAt(tester, const Size(320, 568), textScale: 1.4);
    ...
    await _visitRussianTabs(tester);
    await _disposeApp(tester);
  });

  testWidgets('Russian 412x915 at 2.0x renders all tabs without overflow', (
    tester,
  ) async {
    await _pumpRussianAt(tester, const Size(412, 915), textScale: 2);
    await _visitRussianTabs(tester);
    await _disposeApp(tester);
  });
}
